...
training_path = '/data/tmp_squidle_classify'
...
def classify_patches(image_location,annotations):
    ...
    model = load_model('/data/inception_kelp_nokelp_20ep_9902.model')
    ...
    labelsFullPath = '/data/inceptionv3-kelp_notkelp_labels.txt'
    ...
    # extract patches
    # for local or web-based images - not working for local images
...
if __name__ == "__main__":
    ...
    image_location = '/data/benthoz_examples/PR_20081008_015947_568_LC16.png'
