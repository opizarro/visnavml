...
api_token = "e24239c7486cc7f05ca322efbf3d28184565a7edfb0886a0eac41575" #kelpbot
#api_token = "e3eb9237e12fe3533473d2a28b12bf6d01b24e41099f036ea2bcdd11" # kelpbot online
original_annotation_set_id = [147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 169, 171, 173, 175, 177, 178, 180, 181, 182, 183, 184, 194]
# 147 ?
#
###  "48" # second set from WA # ""28"first set from WA
...
for asi in original_annotation_set_id:
    print "annotation set id " + str(asi)
    original_annotation_set = sq.get_annotation_set(asi)
    ...
    for m in media_list['objects']:
        ...
        media_annotations = sq.get_media_annotations(m['id'], asi)
